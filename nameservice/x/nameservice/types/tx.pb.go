...
func init() {
	...
	proto.RegisterType((*MsgSetName)(nil), "xmonader.nameservice.nameservice.MsgSetName")
	proto.RegisterType((*MsgSetNameResponse)(nil), "xmonader.nameservice.nameservice.MsgSetNameResponse")
	proto.RegisterType((*MsgDeleteName)(nil), "xmonader.nameservice.nameservice.MsgDeleteName")
	proto.RegisterType((*MsgDeleteNameResponse)(nil), "xmonader.nameservice.nameservice.MsgDeleteNameResponse")
}
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	,
}
...
func (c *msgClient) SetName(ctx context.Context, in *MsgSetName, opts ...grpc.CallOption) (*MsgSetNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xmonader.nameservice.nameservice.Msg/SetName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteName(ctx context.Context, in *MsgDeleteName, opts ...grpc.CallOption) (*MsgDeleteNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xmonader.nameservice.nameservice.Msg/DeleteName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xmonader.nameservice.nameservice.Msg/SetName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xmonader.nameservice.nameservice.Msg/DeleteName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
